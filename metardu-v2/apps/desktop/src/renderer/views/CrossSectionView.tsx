...
export const CrossSectionView: React.FC = () => {
  ...
  const svgHtml = useMemo(() => {
    ...
    // 🛡️ Sentinel: Sanitize raw SVG before rendering it with dangerouslySetInnerHTML
    // to prevent potential Cross-Site Scripting (XSS) vulnerabilities via malicious injected SVG elements.
